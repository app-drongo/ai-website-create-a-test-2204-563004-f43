...
export default function Footer() {
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Reach Our Team', href: '#contact' },
      ],
    },
    {
      title: 'Developer Hub',
  ...
  const socialLinks = [
    ...
    { name: 'Facebook', icon: Facebook, href: 'https://facebook.com/minimaltech' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl">MinimalTech</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Streamlining enterprise technology with elegant, scalable solutions. Trusted by 500+
                tech professionals who value simplicity and performance.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">engineering@minimaltech.dev</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Phone className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">+1 (415) 892-7340</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Weekly tech insights and platform updates. Unsubscribe anytime.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="hidden sm:inline flex items-center gap-1">
                Built with <Heart className="size-3 text-primary fill-current" /> for developers
              </span>
            </div>
